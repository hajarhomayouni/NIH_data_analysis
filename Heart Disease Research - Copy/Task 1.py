...
print(pd.isna(df1['world_rank']).sum())

# Instead of saving to the existing Heart_Disease.csv this will create a new file.
# This is a precaution in case the original csv file is needed.
